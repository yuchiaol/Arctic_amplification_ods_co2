...
if True:
   ...
   ax1 = fig.add_axes([0.08, 0.44, 0.3, 0.27])
...
#   plt.plot([4]*10000,xx*factor,'.', color='gold', alpha=0.05)
   ...
   plt.title('(a) Arctic annual SIE trend', fontsize=12)
...
#   plt.axis([0.5, 3.5, -2.5, 0.5])
   ...
   factor = 1./1000000000000
   ax1 = fig.add_axes([0.445, 0.44, 0.54, 0.27])
   plt.plot([0,0],[0,45],'-',color='gray')
...
#   plt.hist(xx, bins=25, color='y',alpha=0.7, rwidth=0.8, label='Hist-xOO')
   ...
   plt.title('(b) Arctic annual SIE trend distribution', fontsize=12)
